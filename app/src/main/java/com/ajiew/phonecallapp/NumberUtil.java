...
public class NumberUtil {
    ...
    public static void main(String[] args) {
        ...
        boolean cellPhone = isCellPhone("13951699549");
        System.out.println(num + "" + cellPhone);

        num = checkNumber("03542465806");
        boolean fixedPhone = isFixedPhone("03542465806");
        System.out.println(num + "" + fixedPhone);

        num = checkNumber("01051274398");
        System.out.println(num);
